...
public:
    ...
    TEST_METHOD(assignNode_getPattern_differentExpressions_success) {
        ...
        ExprNode* plusNode = new ExprNode(ExprNodeValueType::operand, "+");
        ...
        ExprNode* modNode = new ExprNode(ExprNodeValueType::operand, "%");
        ...
        ExprNode* multiplyNode = new ExprNode(ExprNodeValueType::operand, "*");
        multiplyNode->addChild(leafNodeAbc);
        multiplyNode->addChild(leafNode12345);
        ExprNode* divNode = new ExprNode(ExprNodeValueType::operand, "/");
        ...
        ExprNode* plusNode2 = new ExprNode(ExprNodeValueType::operand, "+");
        plusNode2->addChild(leafNodeAlice);
        plusNode2->addChild(leafNodeBob);
        ExprNode* minusNode = new ExprNode(ExprNodeValueType::operand, "-");
